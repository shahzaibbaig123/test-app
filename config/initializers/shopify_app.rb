ShopifyApp.configure do |config|
  ...
  config.api_key = ENV.fetch('SHOPIFY_API_KEY', '6db3443d9216a99c1d095d9864a96727').presence
  config.secret = ENV.fetch('SHOPIFY_API_SECRET', 'e8e039c62a52f13d6f3ef9de30ec01ac').presence
